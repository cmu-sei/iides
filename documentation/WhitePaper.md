...
- *Cyber Data Exchange Model (DEM) (SISO-STD-025-2023)* [[SISO 2023](#references)]
- *Cyber Incident Reporting Framework (CIRF)* outlines protocols for incident documentation and communication [[Cyber Threat Alliance 2023](#references)].
