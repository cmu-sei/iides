...
- **`Industry subsector`**:
 National Security (*92.811*) &mdash; This industry comprises government establishments of the Armed Forces, including the National Guard, primarily engaged in national security and related activities.
- **`Business`**:
 The Foreign Intelligence Agency is a foreign agency focused on intelligence and national security.
- **`Parent company`**:
...
- **`Public`**:
 True
- **`Document`**:
 https://example.com/indictment.pdf
...
- **`Public`**:
 True
- **`Document`**:
 https://example.com/sentencing.pdf
